    ...
    <div className="flex h-[calc(100vh-100px)] items-center justify-center">
      ...
      <h1 className="text-2xl font-bold py-1 head px-10 mb-2">Register</h1>
        ...
        <div className="bg-red-500 p-2 text-white" key={i}>
          ...
          />
          {errors.password && (<p className="text-red-500"> Username is required </p>)}
          <button type="submit" className=" p-2 bg-sky-600 hover:bg-sky-500 text-white font-medium rounded-lg"> Register </button>
        </form>
        <p className="flex gap-x-2 justify-between px-10">
          Already have an account? <Link to="/login" className=" text-sky-500 font-medium">Login</Link>
        </p>
      </div>
    </div>
  );
